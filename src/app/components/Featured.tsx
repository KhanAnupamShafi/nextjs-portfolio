        ...
        <Swiper
          ...
          {projects?.map((project) => (
            <SwiperSlide key={project._id}>
              ...
              />
              <div className="w-10 absolute text-2xl -top-2 flex items-start justify-center rounded-3xl h-full z-2 cursor-pointer">
                {' '}
              </div>
              <div className="absolute grid place-items-center h-10 rounded-r-full text-2xl bottom-5 px-5 bg-[#291720b9]">
