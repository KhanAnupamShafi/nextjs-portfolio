        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <div className="grid gap-y-8 sm:gap-6  sm:grid-cols-2 md:gap-6 lg:grid-cols-3 lg:gap-10 pt-8">
            {projects.map((project) => (
              <article
                key={project._id}
                className="overflow-hidden relative dark:border-zinc-600 rounded-lg border border-gray-100 bg-white shadow-lg dark:bg-[#191729] bg-opacity-10 dark:shadow-[#291720] shadow-teal-100">
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <p className=" line-clamp-3 mt-2 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                    ...
                    ullam hic eos iure vero mollitia. Voluptatum
                    aliquid corrupti dicta cupiditate quia.
                  </p>
                  ...
                  <a
                    href={`/my-projects/${project._id}`}
                    target="_blank"
                    className="relative animate-pulse group mt-4 inline-flex items-center gap-1 text-sm font-medium text-teal-500">
                    Learn More!
